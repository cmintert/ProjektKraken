...
def setup_data(db_connection):
    ...
    db_connection.execute("INSERT INTO markers (id, map_id) VALUES ('marker1', 'map1')")
...
class TestTrajectoryRepository:
    def test_insert_and_get_by_marker_id(self, repo, setup_data):
        ...
        results = repo.get_by_marker_id(marker_id)
    ...
    def test_get_by_map_id(self, repo, setup_data):
        ...
        repo._connection.execute(
            "INSERT INTO markers (id, map_id) VALUES ('marker2', 'map2')"
        )
