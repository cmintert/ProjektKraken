...
def test_add_marker_without_map(map_view):
    ...
    map_view.add_marker("marker1", "entity", 0.5, 0.5)
...
def test_clear_markers(map_view):
    ...
    map_view.add_marker("marker1", "entity", 0.2, 0.3)
    map_view.add_marker("marker2", "event", 0.7, 0.8)
...
def test_marker_position_changed_signal(map_widget, qtbot):
    ...
    map_widget.add_marker("marker1", "entity", 0.5, 0.5)
...
def test_marker_item_colors():
    ...
    entity_marker = MarkerItem("m1", "entity", mock_pixmap_item)
    event_marker = MarkerItem("m2", "event", mock_pixmap_item)
    default_marker = MarkerItem("m3", "unknown", mock_pixmap_item)
