...
class TestMainWindowProtocol:
    ...
    def test_valid_implementation(self):
        ...
        not data attributes. This test verifies the core methods are present.
        """

        class ValidMainWindow:
            """Mock MainWindow that implements the protocol methods."""
        ...
        # Check required methods are present (isinstance only checks methods)
        required_methods = [
            "_on_configure_grouping_requested",
            "_on_clear_grouping_requested",
            "_request_calendar_config",
        ...
        for method in required_methods:
            ...
            assert callable(getattr(window, method)), f"Not callable: {method}"

        # Check required core attributes
        assert hasattr(window, "worker")
        assert hasattr(window, "command_requested")
