...
def test_mainwindow_check_unsaved_changes(qtbot):
    ...
    with (
        ...
        with patch("src.app.main_window.QMessageBox.warning", return_value=QMessageBox.Save):
        ...
        with patch("src.app.main_window.QMessageBox.warning", return_value=QMessageBox.Cancel):
            with patch.object(mock_event_editor, "_on_save") as mock_on_save:
