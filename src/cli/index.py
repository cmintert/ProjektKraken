...
def rebuild_index(args) -> int:
    ...
    try:
        ...
        # Rebuild index
        counts = search_service.rebuild_index(object_types=object_types)
...
def index_object(args) -> int:
    ...
    try:
        ...
        # Index the object
        if args.type == "entity":
            search_service.index_entity(args.id)
        elif args.type == "event":
            search_service.index_event(args.id)
        else:
