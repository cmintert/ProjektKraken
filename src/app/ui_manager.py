...
from src.app.constants import (
    DOCK_TITLE_PROJECT, DOCK_TITLE_EVENT_INSPECTOR,
    DOCK_TITLE_ENTITY_INSPECTOR, DOCK_TITLE_TIMELINE,
    DOCK_OBJ_PROJECT, DOCK_OBJ_EVENT_INSPECTOR,
    DOCK_OBJ_ENTITY_INSPECTOR, DOCK_OBJ_TIMELINE
)
...
class UIManager:
    ...
    def setup_docks(self, widgets: dict):
        ...
        self.docks['event'] = self._create_dock(
            DOCK_TITLE_EVENT_INSPECTOR, DOCK_OBJ_EVENT_INSPECTOR, widgets['event_editor']
        )
        ...
        self.docks['entity'] = self._create_dock(
            DOCK_TITLE_ENTITY_INSPECTOR, DOCK_OBJ_ENTITY_INSPECTOR, widgets['entity_editor']
        )
