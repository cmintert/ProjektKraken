...
RELATION_PICKER_MIN_WIDTH = 180
RELATION_PICKER_MAX_WIDTH = 250
RELATION_PICKER_MIN_HEIGHT = 100
RELATION_PICKER_MAX_HEIGHT = 300
...
NAVIGATION_SELECTION_DELAY_MS = (
    150  # Delay to allow drag operations to cancel selection
)
