...
class LabelManager:
    ...
    # Candidate offsets as (dx_factor, dy_factor) relative to marker size.
    ...
    # Small gap (pixels) between marker icon and label.
    _PADDING = 2.0
    ...
    def run_layout_pass(
        ...
        # Step 2 – sort by priority (higher connection_count first).
